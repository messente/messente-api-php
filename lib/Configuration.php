...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.messente.com/v1';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/3.5.0/PHP';
    ...
    {
        $report  = 'PHP SDK (Messente\Api) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2.0.0' . PHP_EOL;
        $report .= '    SDK Package Version: 3.5.0' . PHP_EOL;
