...
class BlacklistApi
{
     ...
     */
    public function addToBlacklistRequest($numberToBlacklist)
    {
        ...
        if (isset($numberToBlacklist)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($numberToBlacklist));
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteFromBlacklistRequest($phone)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function fetchBlacklistRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function isBlacklistedRequest($phone)
    {
        // verify the required parameter 'phone' is set
        if ($phone === null || (is_array($phone) && count($phone) === 0)) {
            throw new \InvalidArgumentException(
