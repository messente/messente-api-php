...
class DeliveryReportApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveDeliveryReport'] to see the possible values for this operation
     *
     ...
     */
    public function retrieveDeliveryReport($omnimessageId, string $contentType = self::contentTypes['retrieveDeliveryReport'][0])
    {
        list($response) = $this->retrieveDeliveryReportWithHttpInfo($omnimessageId, $contentType);
        return $response;
    }
     ...
     */
    public function retrieveDeliveryReportWithHttpInfo($omnimessageId, string $contentType = self::contentTypes['retrieveDeliveryReport'][0])
    {
        $request = $this->retrieveDeliveryReportRequest($omnimessageId, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\Messente\Api\Model\DeliveryReportResponse' === '\SplFileObject') {
                        ...
                        if ('\Messente\Api\Model\DeliveryReportResponse' !== 'string') {
                            try {
     ...
     */
    public function retrieveDeliveryReportAsync($omnimessageId, string $contentType = self::contentTypes['retrieveDeliveryReport'][0])
    {
        return $this->retrieveDeliveryReportAsyncWithHttpInfo($omnimessageId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveDeliveryReportAsyncWithHttpInfo($omnimessageId, string $contentType = self::contentTypes['retrieveDeliveryReport'][0])
    {
        $returnType = '\Messente\Api\Model\DeliveryReportResponse';
        $request = $this->retrieveDeliveryReportRequest($omnimessageId, $contentType);
     ...
     */
    public function retrieveDeliveryReportRequest($omnimessageId, string $contentType = self::contentTypes['retrieveDeliveryReport'][0])
    {
