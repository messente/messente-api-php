...
class OmnimessageApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cancelScheduledMessage'] to see the possible values for this operation
     *
     ...
     */
    public function cancelScheduledMessage($omnimessageId, string $contentType = self::contentTypes['cancelScheduledMessage'][0])
    {
        list($response) = $this->cancelScheduledMessageWithHttpInfo($omnimessageId, $contentType);
        return $response;
    }
     ...
     */
    public function cancelScheduledMessageWithHttpInfo($omnimessageId, string $contentType = self::contentTypes['cancelScheduledMessage'][0])
    {
        $request = $this->cancelScheduledMessageRequest($omnimessageId, $contentType);
     ...
     */
    public function cancelScheduledMessageAsync($omnimessageId, string $contentType = self::contentTypes['cancelScheduledMessage'][0])
    {
        return $this->cancelScheduledMessageAsyncWithHttpInfo($omnimessageId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cancelScheduledMessageAsyncWithHttpInfo($omnimessageId, string $contentType = self::contentTypes['cancelScheduledMessage'][0])
    {
        $returnType = 'object';
        $request = $this->cancelScheduledMessageRequest($omnimessageId, $contentType);
     ...
     */
    public function cancelScheduledMessageRequest($omnimessageId, string $contentType = self::contentTypes['cancelScheduledMessage'][0])
    {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['sendOmnimessage'] to see the possible values for this operation
     *
     * @throws \Messente\Api\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function sendOmnimessage($omnimessage, string $contentType = self::contentTypes['sendOmnimessage'][0])
    {
        list($response) = $this->sendOmnimessageWithHttpInfo($omnimessage, $contentType);
        return $response;
    }
     ...
     */
    public function sendOmnimessageWithHttpInfo($omnimessage, string $contentType = self::contentTypes['sendOmnimessage'][0])
    {
        $request = $this->sendOmnimessageRequest($omnimessage, $contentType);
            ...
            switch($statusCode) {
                case 201:
                    if ('\Messente\Api\Model\OmniMessageCreateSuccessResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Messente\Api\Model\OmniMessageCreateSuccessResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendOmnimessageAsync($omnimessage, string $contentType = self::contentTypes['sendOmnimessage'][0])
    {
        return $this->sendOmnimessageAsyncWithHttpInfo($omnimessage, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendOmnimessageAsyncWithHttpInfo($omnimessage, string $contentType = self::contentTypes['sendOmnimessage'][0])
    {
        $returnType = '\Messente\Api\Model\OmniMessageCreateSuccessResponse';
        $request = $this->sendOmnimessageRequest($omnimessage, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendOmnimessageRequest($omnimessage, string $contentType = self::contentTypes['sendOmnimessage'][0])
    {
        ...
        if (isset($omnimessage)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($omnimessage));
            } else {
                $httpBody = $omnimessage;
            }
