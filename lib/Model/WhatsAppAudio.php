 ...
 *
 * @category Class
 * @description WhatsApp audio content. Either \&quot;id\&quot; or \&quot;link\&quot; must be provided, but not both.
 * @package  Messente\Api
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class WhatsAppAudio implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier for the audio file.
     *
     * @return self
     */
     ...
     * Sets mimeType
     *
     * @param string|null $mimeType MIME type of the audio file.
     *
     * @return self
     */
     ...
     * Sets link
     *
     * @param string|null $link URL link to the audio file.
     *
     * @return self
     */
