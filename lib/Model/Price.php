 ...
 *
 * @category Class
 * @description An object containing the pricing information for a given country
 * @package  Messente\Api
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Price implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'prefix' => 'string',
        'networks' => '\Messente\Api\Model\PriceNetworksInner[]'
    ];
    ...
    */
     ...
     * Sets country
     *
     * @param string $country The alpha-2 code for the country
     *
     * @return self
     */
     ...
     * Sets prefix
     *
     * @param string $prefix The country code prefix
     *
     * @return self
     */
     ...
     * Gets networks
     *
     * @return \Messente\Api\Model\PriceNetworksInner[]
     */
     ...
     * Sets networks
     *
     * @param \Messente\Api\Model\PriceNetworksInner[] $networks A list of networks available in the country
     *
     * @return self
     */
