 ...
 *
 * @category Class
 * @description Viber message content. You must provide one of these combinations:  * image_url  * text  * text, button_text and button_url  * text, image_url, button_text and button_url  * video  * video, text  * video, text, button_text  * video, text, button_text and button_url  * carousel and text
 * @package  Messente\Api
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Viber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'template' => '\Messente\Api\Model\ViberTemplate',
    ...
    */
     ...
     * Gets template
     *
     * @return \Messente\Api\Model\ViberTemplate|null
     */
     ...
     * Sets template
     *
     * @param \Messente\Api\Model\ViberTemplate|null $template template
     *
     * @return self
     */
