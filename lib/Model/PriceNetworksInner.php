...
/**
 * PriceNetworksInner Class Doc Comment
 *
 * @category Class
 * @description An object containing the network information
 * @package  Messente\Api
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PriceNetworksInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Price_networks_inner';
    ...
    */
     ...
     * Sets price
     *
     * @param string $price The price for sending a message to this network
     *
     * @return self
     */
     ...
     * Sets mccmnc
     *
     * @param float $mccmnc The MCCMNC code for the network
     *
     * @return self
     */
